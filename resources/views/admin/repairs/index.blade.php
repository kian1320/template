...
<div class="container-fluid px-4">
    ...
    <div class="card">
        <div class="card-header">
            <h4> Add Repair History to {{ strtoupper($Item->name) }}<a href="{{ URL::to('/') }}/admin/items"
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td>
                        <form method="post" action="{{ URL::to('/') }}/admin/add-repairs">
                            ...
                            <tbody>
                                @foreach ($Item->repairs as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/edit-repairs/' . $item->id) }}"
                                                class="btn btn-primary btn-sm">Edit</a>

                                            <a href="{{ url('admin/delete-repairs/' . $item->id) }}"
